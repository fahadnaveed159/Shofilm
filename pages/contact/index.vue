<template>
    <div class="px-6 text-white py-10 flex flex-col items-center justify-center h-screen bg-[#0f0f0f]">
     
      <div class="flex flex-col text-center items-center justify-center">
      <h1 class="text-4xl font-medium">Thank You For Contact Me ⭐</h1>
      <p class="w-1/2 text-slate-200 py-4 font-medium">"ShoFilm is Pakistan's leading movie streaming platform, bringing you the best in cinema entertainment. Contact us for partnerships, feedback, or just to say hello!"</p>
    </div>
   <div class="bg-red-600 space-y-2 w-full h-1"></div>
    ...
    © 2025 <span class="text-white font-semibold">Shofilm</span>. All rights reserved.
    <br />
